...
class AccountsController extends ApiAppController
{
    ...
    public function get()
    {
        ...
        $dataReturn = [
            ...
            "point" => AppUtil::handleNumberNull($this->authUser->point, "int"),
        ];
    ...
    {        
        ...
        if (isset($dataGet["marriage"])) {
            $conditions["Accounts.marriage LIKE"] = "%" . $dataGet["marriage"] . "%";
        }
        
        if (isset($dataGet["purpose"])) {
            $conditions["Accounts.purpose LIKE"] = "%" . $dataGet["purpose"] . "%";
        }
    ...
    public function register()
    {
        ...
        $account->revision = 1;
        $account->intro = 'はじめまして。宜しくお願いします♪';
    ...
    public function update()
    {
        ...
        if (isset($dataPost["marriage"])) {
            $this->authUser->marriage = trim($dataPost["marriage"]);
        }
        if (isset($dataPost["purpose"])) {
            $this->authUser->purpose = trim($dataPost["purpose"]);
        }
        ...
        if ($this->Accounts->save($this->authUser)) {
            ...
            $payload = [
                ...
                "profile" => [
                    ...
                    "user_agent" => $this->clientDevice['user-agent'],
                    "marriage" => $dataReturn["marriage"],
                    "purpose" => $dataReturn["purpose"],
    ...
    public function updatePoint()
    {
        ...
        if (isset($dataPost["point"])) {
            if (!is_numeric($dataPost["point"])) {
                
                return $this->responseData(["error_code" => 102]);
            }
            $pt = $this->authUser->point;
            $this->authUser->point = $pt + $dataPost["point"];
        }
        if ($this->Accounts->save($this->authUser)) {
